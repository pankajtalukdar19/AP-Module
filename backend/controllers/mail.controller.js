  ...
  let mailOptions = {
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
      <table width="100%" cellspacing="0" cellpadding="0" style="background-color: #f8f9fa; padding: 20px;">
        ...
        <tr>
          <td align="center" style="padding: 20px;">
            <a href="http://localhost:3000/approve?id=${data.savedEntryId._id}" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: #fff; text-decoration: none; border-radius: 4px; margin-right: 10px;"> Approve </a>
            <a href="http://localhost:3000/reject?id=${data.savedEntryId._id}" style="display: inline-block; padding: 10px 20px; background-color: #dc3545; color: #fff; text-decoration: none; border-radius: 4px; margin-right: 10px;"> Reject </a>
          </td>
        </tr>
        <tr>
